...
BEGIN
	...
	--~~~~~~~~~~~~ Stage 2. Promotion pre-fitlering and Goegraphy expansion ~~~~~~~~--
	...
	Begin
		...
		Select @NumberOfAttachment = count(*) From Playbook.PromotionAttachment pa Join #Promotion  p on pa.PromotionID = p.PromotionID
		Select @TotalAttachmentSize = Sum(Coalesce(AttachmentSize, 0)) From Playbook.PromotionAttachment pa Join #Promotion  p on pa.PromotionID = p.PromotionID
