...
If Exists (Select * From sys.procedures Where object_id = object_id('BCMyday.pGetBCPromotionsForGSN10'))
	Drop Proc BCMyday.pGetBCPromotionsForGSN10
Go
...
/*
exec BCMyday.pGetBCPromotionsForGSN10 @GSN = 'BUTJX004', @EnableLogging = 1, @Debug = 1

exec BCMyday.pGetBCPromotionsForGSN10 @GSN = 'BUTJX004', @Debug = 1, @EnableLogging = 1

exec BCMyday.pGetBCPromotionsForGSN10 @GSN = 'WATBX001', @Debug = 1

exec BCMyday.pGetBCPromotionsForGSN10 @GSN = 'WATBX001', @EnableLogging = 1

exec BCMyday.pGetBCPromotionsForGSN10 @GSN = 'ALBDX003', @EnableLogging = 1

exec BCMyday.pGetBCPromotionsForGSN10 @GSN = 'BUTJX004', @EnableLogging = 1

exec BCMyday.pGetBCPromotionsForGSN10 @GSN = 'WATBX001', @Debug = 1, @EnableLogging = 1

*/

Create Proc BCMyday.pGetBCPromotionsForGSN10
(
	@GSN Varchar(50), 
