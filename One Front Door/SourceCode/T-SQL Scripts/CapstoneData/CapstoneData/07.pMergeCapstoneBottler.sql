...
Begin
	Drop Proc ETL.pMergeCapstoneBottler
End
Go
...
AS		
	...
	Using ( 
			Select a.BP_ID,
			dbo.udf_TitleCase(Case When a.[ADDR_LINE_1] = 'Xxxx Xxxxxxxxxx Xx' Then Null Else a.[ADDR_LINE_1] End) ADDR_LINE_1,
			dbo.udf_TitleCase(Case When a.[ADDR_CITY] = 'Xxxxxxxxxx' Then Null Else a.[ADDR_CITY] End) ADDR_CITY,
			a.ADDR_REGION_ABRV,
			a.[ADDR_PSTL_CODE],
			a.EMAIL,
			a.PHN_NBR,
