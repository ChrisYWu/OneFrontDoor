...
If Exists (Select * From sys.procedures Where object_id = object_id('SupplyChain.pImportSafetyRecordable'))
Begin
	Drop Proc SupplyChain.pImportSafetyRecordable
End
Go

/*
------ Test -------
exec SupplyChain.pImportSafetyRecordable
exec SupplyChain.pImportSafetyRecordable 1
...
Create Proc SupplyChain.pImportSafetyRecordable
(
	@RefreshAll bit = 0
)
As
