...
Print 'Role Creation Started'
	...
	Values ('SC Plant Manager', 'SC Plant Manager', 'SCPM', 'Supply Chain Plant Manager',0,1,'',1,1,null,'http://splashnet-int/Pages/ManufacturingOperations.aspx','KAVSX001', 'KAVSX001',GETDATE(),'',6)

	Insert into Settings.PortalRole 
	Values ('Supply chain Inventory', 'Supply chain Inventory', 'SCI', 'Supply chain Inventory',0,1,'',1,1,null,'http://splashnet-int/Pages/InventoryOperations.aspx','KAVSX001', 'KAVSX001',GETDATE(),'',6)
...
Print 'Behavior Member Creation Started'
	...
	Insert into Settings.BehaviorMember
	Values ((Select top 1 BehaviorID from Settings.Behavior Where BehavoirName = 'SC Manufacturing Reports'),'TME Single Branch','TME Single Branch','TME Report URL for Individual Branch',1,'http://splashnet-int.dpsg.net/MySplashNetforSupplyChain/_layouts/ReportServer/RSViewerPage.aspx?rv:RelativeReportUrl=/MySplashNetforSupplyChain/Reports/TMEForMultiPlants.rdl&rv:ParamMode=Hidden&rv:Toolbar=Full&rv:HeaderArea=None{0}&rp:D={1}&rv:toolbaritemsdisplaymode=154','KAVSX001','KAVSX001',getdate(),1)
	...
	Insert into Settings.BehaviorMember
	Values ((Select top 1 BehaviorID from Settings.Behavior Where BehavoirName = 'SC Manufacturing Reports'),'AFCO Single Branch','AFCO Single Branch','AFCO Report URL for Individual Branch',(Select Max(Precedence) + 1 from settings.BehaviorMember Where BehaviorID in ((Select top 1 BehaviorID from Settings.Behavior Where BehavoirName = 'SC Manufacturing Reports'))),'http://splashnet-int.dpsg.net/MySplashNetforSupplyChain/_layouts/ReportServer/RSViewerPage.aspx?rv:RelativeReportUrl=/MySplashNetforSupplyChain/Reports/AFCOMulti.rdl&rv:ParamMode=Hidden&rv:Toolbar=Full&rv:HeaderArea=None{0}&rp:D={1}&rv:toolbaritemsdisplaymode=154','KAVSX001','KAVSX001',getdate(),1)
	...
	Insert into Settings.BehaviorMember
	Values ((Select top 1 BehaviorID from Settings.Behavior Where BehavoirName = 'SC Manufacturing Reports'),'Inventory Cases Single Branch','Inventory Cases Single Branch','Inventory Cases Report URL for Individual Branch',(Select Max(Precedence) + 1 from settings.BehaviorMember Where BehaviorID in ((Select top 1 BehaviorID from Settings.Behavior Where BehavoirName = 'SC Manufacturing Reports'))),'http://splashnet-int.dpsg.net/MySplashNetforSupplyChain/_layouts/ReportServer/RSViewerPage.aspx?rv:RelativeReportUrl=/MySplashNetforSupplyChain/Reports/MfgPlantInventoryMulti.rdl&rv:ParamMode=Hidden&rv:Toolbar=Full&rv:HeaderArea=None{0}&rp:D={1}&rv:toolbaritemsdisplaymode=154','KAVSX001','KAVSX001',getdate(),1)
