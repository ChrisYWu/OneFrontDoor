...
---- The Golden query ----
Select Distinct t.TradeMarkID, t.TradeMarkName, r.RegionName, map.BottlerID, BCBottlerID, BottlerName, map.AccountID, LocalchainName, map.ChannelID, a.SAPAccountNumber, a.AccountName, a.PostalCode
--Select *
