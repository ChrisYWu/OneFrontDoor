...
{
   public class DSDDeliveryConnectionWrapper
    {
        DSDDeliveryConnection _connection;

        protected DSDDeliveryConnection dbConnection
        {
        ...
        {
            _connection = new DSDDeliveryConnection();
        }
