...
export class StoresetupMainComponent implements OnInit {
    ...
    public selectedBranch: MerchBranch = new MerchBranch();
    public selectedMerchGroupID: number = 0;
    public inputAcctList: Array<any> = [];
    public inputAcctLookupList: Array<any> = [];
    ...
    @ViewChild(StoredetailComponent) private storeDetailCmp: StoredetailComponent;

    public routesList: Array<any> = [];
    public selStoreInfo: StoreInfo;
    public selDefaultRoute: RouteInfo;
    public weekDays: Array<StoreSetupDOW> = [];
    public removeStore: StoreInfo;
    ...
    initalizeStoreDetail() {
        this.weekDays = [{ Weeknumber: 2, WeekName: 'Monday', FirstPull: false, SecondPull: false, RouteName: "", RouteNameBackup: "" },
        { Weeknumber: 3, WeekName: 'Tuesday', FirstPull: false, SecondPull: false, RouteName: "", RouteNameBackup: "" },
        { Weeknumber: 4, WeekName: 'Wednesday', FirstPull: false, SecondPull: false, RouteName: "", RouteNameBackup: "" },
        { Weeknumber: 5, WeekName: 'Thursday', FirstPull: false, SecondPull: false, RouteName: "", RouteNameBackup: "" },
        { Weeknumber: 6, WeekName: 'Friday', FirstPull: false, SecondPull: false, RouteName: "", RouteNameBackup: "" },
        { Weeknumber: 7, WeekName: 'Saturday', FirstPull: false, SecondPull: false, RouteName: "", RouteNameBackup: "" },
        { Weeknumber: 1, WeekName: 'Sunday', FirstPull: false, SecondPull: false, RouteName: "", RouteNameBackup: "" }];
    ...
    onStoreSave() {
        this.storeDetailCmp.onStoreMainSave();
    }

    onStoreCancel() {
        this.storeDetailCmp.onCancel();
    }
            ...
            .subscribe(res => {
                ...
                if (isLoad) {
                    ...
                    if (d.RouteDetail != null) {
                        ...
                        this.selDefaultRoute.RouteName;
                    }
                        ...
                        for (let w = 0; w < d.WeekDays.length; w++) {
                            this.weekDays.map((item: any) => {
                                if (item.Weeknumber == d.WeekDays[w].Weeknumber) {
                                    ...
                                    item.RouteName = d.WeekDays[w].RouteName;
                                }
                            });
                        }
                    }
                ...
                for (let w = 0; w < result.WeekDays.length; w++) {
                    this.weekDays.map((item: any) => {
                        if (item.Weeknumber == result.WeekDays[w].Weeknumber) {
                            ...
                            item.RouteName = result.WeekDays[w].RouteName;
                        }
                    });
                }
