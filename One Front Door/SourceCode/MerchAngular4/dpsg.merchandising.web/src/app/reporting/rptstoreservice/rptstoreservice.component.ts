...
export class RptstoreserviceComponent implements OnInit {
    ...
    public _webapi: string = MerchConstant.WebAPI_ENDPOINT;

    public isRequesting: boolean;

    @ViewChild('lgModal') lgModal: ModalDirective;
    @ViewChild('lgModalGMap') lgModalGMap: ModalDirective;
    ...
    public pageSizes: boolean = false;
    public previousNext: boolean = true;
    public filterRpt: string;
    public selectedCheckInLocation:string;
    public selectedCheckOutLocation:string;
    ...
    // public MerchColFilter: string;
    // public ChainColFilter: string;
    // public StoreColFilter: string;
    // public ManagerNameColFilter: string; 
   ...
   public sortChange(sort: SortDescriptor[]): void {
    ...
    public loadSearchData(filterRecords): void {
        this.gridView = {
    ...
    public checkNullValues(colValue, filterValue) {
        if (colValue) {
            return colValue.toString().toLowerCase().indexOf(filterValue);
        }
    }

    public SearchFilterRpt() {
    ...
    //      public ColumnFilterChange(columnName){
    ...
    getCheckInLocationMap(checkinLocation:string, address:string, city:string, postalCode:string, state:string) {
        this.selectedCheckInLocation = checkinLocation;
        this.locationTitle = "Check-in Location"; 
        this.locationAddress = address + ', ' + city + ' ' + state + '-' + postalCode;
        this.lgModalGMap.show();
    }
    getCheckOutLocationMap(checkoutLocation:string, address:string, city:string, postalCode:string, state:string) {
        this.selectedCheckOutLocation = checkoutLocation;
        this.locationTitle = "Check-out Location"; 
        this.locationAddress = address + ', ' + city + ' ' + state + '-' + postalCode;
        this.lgModalGMap.show();
    }
