...
@Component({
  selector: 'app-mobile-storelist',
  templateUrl: './mobile-storelist.component.html',
  styleUrls: ['./mobile-storelist.component.scss'],
  providers:[DispserviceService]
})
export class MobileStorelistComponent implements OnInit {
