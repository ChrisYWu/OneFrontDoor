...
export class MerchsetupmainComponent implements OnInit {
    ...
    @ViewChild(MerchdetailComponent) private merchDetailCmp:MerchdetailComponent;
    private selDefaultRoute: RouteData;
    private selDefaultRouteMon: RouteData;
    private selDefaultRouteTue: RouteData;
    private selDefaultRouteWed: RouteData;
    private selDefaultRouteThu: RouteData;
    private selDefaultRouteFri: RouteData;
    private selDefaultRouteSat: RouteData;
    private selDefaultRouteSun: RouteData;
