...
var StoresetupMainComponent = (function () {
    ...
    StoresetupMainComponent.prototype.stopRefreshing = function () {
    ...
    StoresetupMainComponent = __decorate([
        core_1.Component({
            ...
            directives: [common_1.CORE_DIRECTIVES, stores_list_1.StoresListComponent, storedetail_1.StoredetailComponent, storeitem_1.StoreitemComponent, spinner_1.SpinnerComponent],
