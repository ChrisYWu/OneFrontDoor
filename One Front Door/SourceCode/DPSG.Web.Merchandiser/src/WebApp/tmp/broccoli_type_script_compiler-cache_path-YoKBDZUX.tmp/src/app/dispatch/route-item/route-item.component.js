...
var RouteItemComponent = (function () {
    ...
    RouteItemComponent.prototype.breakImageCaption = function (orginalText) {
        var cap;
        if (orginalText.length > 25) {
            cap.Name1 = orginalText.substring(0, 24);
            cap.Name2 = orginalText.substring(24, orginalText.length + 1);
        }
        else {
            cap.Name1 = orginalText;
            cap.Name2 = " ";
        }
        return cap;
    };
    RouteItemComponent.prototype.getStorePictures = function (storePics) {
        ...
        var _loop_1 = function(i) {
            if (storePics[i].IsReadSASValid) {
                capBreakout = this_1.breakImageCaption(storePics[i].Caption);
                this_1.storePictures.push({
                    'ImageURL': storePics[i].AbsoluteURL + storePics[i].ReadSAS,
                    'Name1': capBreakout.Name1,
                    'Name2': capBreakout.Name2,
                });
            }
            else {
                if (!this_1.readSASDictionary[storePics[i].ContainerID]) {
                    ...
                    this_1.dispService.post(JSON.stringify(extendingReadSASInput), true)
                        ...
                        var capBreakout = _this.breakImageCaption(storePics[i].Caption);
        ...
        var this_1 = this;
        var capBreakout, extendingReadSASInput, imageURL, ;
    ...
    RouteItemComponent.prototype.getBuildExecution = function (builds) {
        ...
        var this_2 = this;
        var extendingReadSASInput, imageURL;
